    ...
    <main className="text-white lg:w-[1008px] mx-auto pb-10 lg:pb-0">
      ...
      <section className="w-full lg:w-[470px] px-4 lg:px-0 mt-8">
        <div className="flex items-center gap-x-3">
          ...
          <span className="text-[#F7FDFD] text-base lg:text-2xl font-normal font-marbold uppercase">
            projects
          </span>
        </div>
      ...
      {/* TODO */}
      {/* search box */}
      <div className="flex flex-col md:flex-row gap-4 w-full items-center justify-start mt-6 px-4 lg:px-0">
        <div
          className="w-full flex items-center bg-[#1A1A1A] rounded-lg p-3 gap-4
        ...
        <div className="flex gap-x-2">
          <div className="relative lg:w-[144px]">
            <button
